...
- **Latency**: The time it takes for a request to be processed and a response to be returned. Lower latency can be important for real-time applications such as video streaming or online gaming.
...
For instance we might consider a simple system with a single device and edge server. Our device has a limited battery capacity 
